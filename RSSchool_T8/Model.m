...
- (instancetype)initDraw:(Drawing) draw {
    ...
    switch (draw) {
        ...
        case landscape:
            return [self initLandscape];
        case planet:
            return [self initPlanet];
        case tree:
            return [self initTree];
    }
}

- (instancetype)initHead {
